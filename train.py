...
parser.add_argument('--resume_checkpoint', type=str, default=None) # None
parser.add_argument('--traintxt', type=str, default='')
parser.add_argument('--validtxt', type=str, default='')
parser.add_argument('--logdir', type=str, default='./logs')
parser.add_argument('--pretrained_path', type=str, default='/vol/das-nobackup/users/jzheng/Polyland_Exp/PSST_1/UUVC/pretrained_LibriTTS360_VCTK_ESD-selected/last.ckpt')
...
parser.add_argument('--val_batch_size', type=float, default=16)
parser.add_argument('--val_bucket_size', type=int, default=10)
parser.add_argument('--training_step', type=int, default=700000)
...
parser.add_argument('--act_layers', type=int, default=1)
...
parser.add_argument('--mel_layers', type=int, default=8) # new_val: 12, old_val: 8
...
parser.add_argument('--n_bands', type=int, default=4) ## we added
parser.add_argument('--new_spk_encoder', type=str, default='no') ## 'yes' ## we added
